      ...
      <div className='max-w mx-5'>
        <div className='flex justify-between items-center'>
          ...
          <div className='hidden md:flex items-center'>
            <a href='/auth/google' className='px-3 py-3 rounded bg-blue-500 hover:bg-blue-600 text-white transition duration-300'>
              <div>Login</div>
            </a>
          </div>
          <div className={`md:hidden flex justify-center items-center w-10 h-10 rounded ${showMenu ? `bg-gray-300` : ''}`}>
